 ...
 * \code
 * 	struct csalt_resource_pair list[arrsize(resources)] = { 0 };
 * \endcode
 *
 ...
 *
 * \param resources_begin The zeroth element of the resources array
 * \param resources_end A pointer one past the end of the resources array
...
void csalt_resource_pair_list_bounds(
	csalt_resource **resources_begin,
	csalt_resource **resources_end,

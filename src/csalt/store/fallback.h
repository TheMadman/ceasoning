 ...
 * store. If data is read from later store successfully, it is
 * written back into earlier store.
 *
 ...
 * The data can be written out to all store by calling
 ...
 * 	from an array of store, in a linked-list
 * 	configuration.
 *

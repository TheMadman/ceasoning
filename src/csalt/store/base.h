 ...
 * data store which do not need to be acquired or
 ...
 * this function.
 */
typedef int csalt_static_store_block_fn(csalt_static_store *store, void *data);
 ...
 * memory), unless used with store which implement those

...
/**
 * \brief The implementation of csalt_store_read() for no-op store.
 */
ssize_t csalt_store_noop_read(csalt_static_store *, void *, ssize_t);

/**
 * \brief The implementation of csalt_store_write() for no-op store.
 */
ssize_t csalt_store_noop_write(csalt_static_store *, void *, ssize_t);

/**
 * \brief The implementation of csalt_store_split() for no-op store.
 */
...
/**
 * \brief The implementation of csalt_store_size() for no-op store.
 */
ssize_t csalt_store_noop_size(csalt_store *);

/**
 * \brief The implementation of csalt_store_resize() for no-op store.
 */
